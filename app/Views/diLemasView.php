...
<body>
    ...
    <div class="form" style="padding-top: 1.2rem;">
        <center>
            <form action="<?= base_url('dilemas/create') ?>" method="post">
                <table>
                    <tr>
                        <th colspan="3">
        ...
        <?php helper('form') ?>
        <ul>
            <?php foreach (validation_errors() as $val) : ?>
            <li><?= $val ?></li>
            <?php endforeach ?>
        </ul>
        <center>
                        ...
                        <?php if (!empty($students)) : ?>
                            ...
                            <?php foreach ($students as $s) : ?>
                                <tr>
                                    ...
                                    <td><?= $s['agama']; ?></td>
                                    <td>
                                        <form action="<?= base_url('dilemas/delete/') . $s['id'] ?>" method="post">
        ...
        <hr>
        <center>
            <form action="<?= base_url('dilemas/update'); ?>" method="post">
                <table>
                    <tr>
                        <th colspan="3">
